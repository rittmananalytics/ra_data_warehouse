{%- macro bootstrap_schemas(staging_schema_name, seed_schema_name, logs_schema_name, reset) -%}
...
{{ drop_schema(target.database, schema_prefix~target.schema~"_"~logs_schema_name) }}
...
{{ create_schema(target.database, schema_prefix~target.schema~"_"~logs_schema_name) }}
