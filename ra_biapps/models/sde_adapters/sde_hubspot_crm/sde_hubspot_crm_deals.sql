...
hubspot_deals as (
  ...
  select
    ...
    properties.dealstage.source as deal_source, -- added 06/11/1
    properties.dealstage.sourceid as deal_salesperson_email, -- added 06/11/2019
    case when properties.closedate.value is not null then true else false end AS deal_is_closed, -- added 18/12/2019
...
deals_fs as (
    ...
    left join hubspot_deal_stages s on d.dealstage = s.stageid
