...
SELECT
  ...
  coalesce(engagement.type,{{ cast() }})   AS  conversation_message_type,
  coalesce(metadata.text,{{ cast() }})    AS conversation_body,
  coalesce(metadata.subject,{{ cast() }})    as  conversation_subject,
