...
renamed AS (
  ...
  {{ cast() }} 	as deliverable_id,
  {{ cast() }}  as deliverable_type,
  {{ cast() }}  as deliverable_category,
  {{ cast() }} 	as sprint_name,
  {{ cast() }}  as sprint_board_url,
   {{ cast(datatype='timestamp') }}  as task_end_ts,
   {{ cast(datatype='timestamp') }} as task_start_ts,
  {{ cast() }}  as sprint_goal,
