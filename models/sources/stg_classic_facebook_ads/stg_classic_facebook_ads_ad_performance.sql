...
{% if 'classic_facebook_ads' in var("marketing_warehouse_ad_performance_sources") %}
...
SELECT
    ...
    cast(null as {{ dbt_utils.type_float() }})        as ad_avg_time_on_site,
    cast(null as {{ dbt_utils.type_float() }})        as ad_bounce_rate,
    cast(null as {{ dbt_utils.type_int() }})          as ad_total_assisted_conversions,
...
SELECT
    ...
    reach                                             as ad_total_reach,
    unique_clicks                                     as as_total_unique_clicks,
    cast(null as {{ dbt_utils.type_float() }})       as ad_total_unique_impressions,
