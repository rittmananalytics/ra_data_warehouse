...
select
       ...
       {{ cast() }}                     as company_id,
       {{ cast() }}                     as project_name,
       {{ cast() }}                     as project_code,
        {{ cast(datatype='timestamp') }}                  as project_delivery_start_ts,
        {{ cast(datatype='timestamp') }}                  as project_delivery_end_ts,
